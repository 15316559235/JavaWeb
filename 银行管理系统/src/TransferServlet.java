...
public class TransferServlet extends HttpServlet {
    ...
    public void invoke() throws Exception{
        ...
        RemoteCall call = new RemoteCall("RPCServiceImpl", "transfer", new Class[]{int.class,String.class,String.class,String.class,String.class}, new Object[]{Money,Password,toUsername,dUsername,dPassword});      // 向服务器发送Call 对象
