...
public class CheckServlet extends HttpServlet {
    ...
    public void invoke() throws Exception{
        ...
        RemoteCall call = new RemoteCall("RPCServiceImpl", "check", new Class[]{String.class,String.class,String.class}, new Object[]{Password,dUsername,dPassword});      // 向服务器发送Call 对象
        oos.writeObject(call);       //接收包含了方法执行结果的Call 对象

        call = (RemoteCall) ois.readObject();
        Money=(int)call.getResult();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher ss = request.getRequestDispatcher("check.jsp");
