...
@WebServlet(name = "DrawServlet",urlPatterns = "/draw.do")
public class DrawServlet extends HttpServlet {
    ...
    public void invoke() throws Exception{
        ...
        RemoteCall call = new RemoteCall("RPCServiceImpl", "draw", new Class[]{int.class,String.class,String.class,String.class}, new Object[]{Money,Password,dUsername,dPassword});      // 向服务器发送Call 对象
