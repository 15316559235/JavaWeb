			...
			<div class="container">
			  ...
			  <ul class="slides">
			    <li data-thumb="images/si.jpg">
			        <div class="thumb-image"> <img src="images/pi5.jpg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
    ...
    controlNav: "thumbnails"
					...
					<div class="col-md-5 single-top-in simpleCart_shelfItem">
						...
						<h4>精品大床房</h4>
							...
							<form action="single2.do" method="post">
		...
		<div class=" bottom-product">
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="single5.jsp"><img class="img-responsive" src="images/pi.jpg" alt="">
							<div class="pro-grid">
										<span class="buy-in">查看</span>
							</div>
						</a>	
						</div>
						<p class="tun"><span>欧式大床房</span><br></p>
						<div class="ca-rt">
					...
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="single6.jsp"><img class="img-responsive" src="images/pi1.jpg" alt="">
							<div class="pro-grid">
										<span class="buy-in">查看</span>
							</div>
						</a>	
						</div>
						<p class="tun"><span>经典大床房</span><br></p>
						<div class="ca-rt">
							<a href="#" class="item_add"><p class="number item_price"><i> </i>¥300.00</p></a>						
						</div>					</div>
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="single7.jsp"><img class="img-responsive" src="images/pi2.jpg" alt="">
							<div class="pro-grid">
										<span class="buy-in">查看</span>
							</div>
						</a>	
						</div>
						<p class="tun"><span>舒适单人间</span><br></p>
						<div class="ca-rt">
