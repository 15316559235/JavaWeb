        ...
        <div class="account-pass">
            <div class="col-md-8 account-top">
                <form method="post" action="login.do">
                    ...
                    <div><span>邮箱Email</span>
                        <input type="text" name="Cid">
                    </div>
                    <div><span>密码Password</span>
            ...
            <div class="col-md-4 left-account ">
                <a href="single1.jsp"><img class="img-responsive " src="images/t1.jpg" alt=""></a>
                <div class="five">
                    <h2>25% </h2><span>discount</span>
                </div>
                <a href="register.jsp" class="create">没有账号？注册</a>
                <div class="clearfix"> </div>
            </div>
            <div class="clearfix"> </div>
        </div>
...
<%
    String ms=(String)request.getAttribute("filtermessage");
    if(ms!=null) {%>
<script type="text/javascript">
    alert("<%=ms%>");
</script>
