			...
			<div class="container">
			  ...
			  <ul class="slides">
			    <li data-thumb="images/si.jpg">
			        <div class="thumb-image"> <img src="images/pi.jpg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
    ...
    controlNav: "thumbnails"
					...
					<div class="col-md-5 single-top-in simpleCart_shelfItem">
						...
						<h4>欧式大床房</h4>
							...
							<h5 class="item_price">¥400.00</h5>
							<p>想干嘛就干嘛</p>


							<form action="single5.do" method="post">
