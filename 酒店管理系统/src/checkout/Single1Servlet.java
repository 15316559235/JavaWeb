...
@WebServlet(name = "Single1Servlet",urlPatterns={"/single1.do"})
public class Single1Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ResultSet rs=stat.executeQuery("select * from room where Rid='1' ");
        ...
        RequestDispatcher ss=request.getRequestDispatcher("single1.jsp");
